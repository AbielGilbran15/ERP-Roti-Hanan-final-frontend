...
export const auditLogs: AuditLog[] = [
  ...
  { id: "audit-002", entityType: "Barang Jadi", recordId: "prd-roti-cokelat", recordLabel: "RJ-001 — Roti Sobek Coklat", action: "Diubah", changes: ["Harga Agen 1: Rp8.500 → Rp9.000", "Harga Agen 2: Rp9.000 → Rp9.500"], actorId: "usr-rina", actorName: "Rina Marlina", createdAt: "2026-08-22T16:10:00+07:00" },
];

export const products: Product[] = [
  { id: "prd-roti-cokelat", code: "RJ-001", name: "Roti Sobek Coklat", type: "Produk Jadi", productType: "Roti Manis", stockUnit: "Pcs", conversionValue: 1, purchasePrice: 0, salesUnit: "Pcs", weightValue: 80, weightUnit: "Gram", agent1Price: 9000, agent2Price: 9500, cost: 4680, shelfLifeDays: 5, minStock: 100, requiresQc: true, notes: "QC akhir wajib sebelum dijual.", isActive: true },
  { id: "prd-tawar", code: "RJ-002", name: "Roti Tawar", type: "Produk Jadi", productType: "Roti Tawar", stockUnit: "Pcs", conversionValue: 1, purchasePrice: 0, salesUnit: "Pcs", weightValue: 400, weightUnit: "Gram", agent1Price: 17000, agent2Price: 18000, cost: 9200, shelfLifeDays: 5, minStock: 60, requiresQc: true, notes: "Produk roti tawar reguler.", isActive: true },
  { id: "prd-croissant", code: "RJ-003", name: "Croissant", type: "Produk Jadi", productType: "Pastry", stockUnit: "Pcs", conversionValue: 1, purchasePrice: 0, salesUnit: "Pcs", weightValue: 65, weightUnit: "Gram", agent1Price: 11000, agent2Price: 12000, cost: 6100, shelfLifeDays: 3, minStock: 60, requiresQc: true, notes: "Simpan dalam kemasan tertutup.", isActive: true },
  { id: "prd-donat", code: "RJ-004", name: "Donat", type: "Produk Jadi", productType: "Donat", stockUnit: "Pcs", conversionValue: 1, purchasePrice: 0, salesUnit: "Pcs", weightValue: 55, weightUnit: "Gram", agent1Price: 6000, agent2Price: 6500, cost: 3100, shelfLifeDays: 2, minStock: 100, requiresQc: true, notes: "QC visual dan berat.", isActive: true },
  { id: "prd-roti-susu", code: "RJ-005", name: "Roti Susu", type: "Produk Jadi", productType: "Roti Manis", stockUnit: "Pcs", conversionValue: 1, purchasePrice: 0, salesUnit: "Pcs", weightValue: 60, weightUnit: "Gram", agent1Price: 8000, agent2Price: 8500, cost: 4120, shelfLifeDays: 3, minStock: 120, requiresQc: true, notes: "", isActive: true },
  { id: "prd-roti-keju", code: "RJ-006", name: "Roti Keju", type: "Produk Jadi", productType: "Roti Manis", stockUnit: "Pcs", conversionValue: 1, purchasePrice: 0, salesUnit: "Pcs", weightValue: 60, weightUnit: "Gram", agent1Price: 9500, agent2Price: 10000, cost: 5020, shelfLifeDays: 3, minStock: 100, requiresQc: true, notes: "", isActive: true },
  { id: "prd-pisang", code: "RJ-007", name: "Bolen Pisang", type: "Produk Jadi", productType: "Pastry", stockUnit: "Pcs", conversionValue: 1, purchasePrice: 0, salesUnit: "Pcs", weightValue: 55, weightUnit: "Gram", agent1Price: 7000, agent2Price: 7500, cost: 3890, shelfLifeDays: 4, minStock: 80, requiresQc: true, notes: "", isActive: true },
  { id: "raw-tepung", code: "BB-001", name: "Tepung Terigu", type: "Bahan Baku", purchaseUnit: "Karung", purchaseContentValue: 25, purchaseContentUnit: "Kg", stockUnit: "Kg", conversionValue: 25, purchasePrice: 300000, agent1Price: 0, agent2Price: 0, cost: 12000, shelfLifeDays: 180, minStock: 50, requiresQc: true, notes: "1 Karung berisi 25 Kg.", isActive: true },
  { id: "raw-gula", code: "BB-002", name: "Gula Pasir", type: "Bahan Baku", purchaseUnit: "Karung", purchaseContentValue: 50, purchaseContentUnit: "Kg", stockUnit: "Kg", conversionValue: 50, purchasePrice: 850000, agent1Price: 0, agent2Price: 0, cost: 17000, shelfLifeDays: 365, minStock: 120, requiresQc: true, notes: "1 Karung berisi 50 Kg.", isActive: true },
  { id: "raw-mentega", code: "BB-003", name: "Mentega Bakery", type: "Bahan Baku", purchaseUnit: "Karton", purchaseContentValue: 10, purchaseContentUnit: "Kg", stockUnit: "Kg", conversionValue: 10, purchasePrice: 565000, agent1Price: 0, agent2Price: 0, cost: 56500, shelfLifeDays: 120, minStock: 80, requiresQc: true, notes: "1 Karton berisi 10 Kg.", isActive: true },
  { id: "raw-ragi", code: "BB-005", name: "Ragi", type: "Bahan Baku", purchaseUnit: "Pack", purchaseContentValue: 500, purchaseContentUnit: "Gram", stockUnit: "Gram", conversionValue: 500, purchasePrice: 40000, agent1Price: 0, agent2Price: 0, cost: 80, shelfLifeDays: 90, minStock: 5000, requiresQc: true, notes: "1 Pack berisi 500 Gram.", isActive: true },
  { id: "pack-plastik", code: "KP-001", name: "Plastik Roti", type: "Kemasan", purchaseUnit: "Pack", purchaseContentValue: 100, purchaseContentUnit: "Pcs", stockUnit: "Pcs", conversionValue: 100, purchasePrice: 35000, agent1Price: 0, agent2Price: 0, cost: 350, shelfLifeDays: 730, minStock: 3000, requiresQc: false, notes: "1 Pack berisi 100 Pcs.", isActive: true },
];

export const stocks: StockItem[] = [
  { id: "stk-001", productId: "raw-tepung", warehouse: "Gudang Bahan Baku", lot: "TPG-260815-A", expiryDate: "2027-02-11", onHand: 428, reserved: 112, status: "Tersedia" },
  { id: "stk-002", productId: "raw-gula", warehouse: "Gudang Bahan Baku", lot: "GLA-260801-B", expiryDate: "2027-08-01", onHand: 96, reserved: 24, status: "Tersedia" },
  { id: "stk-003", productId: "raw-mentega", warehouse: "Area Karantina", lot: "MTG-260820-C", expiryDate: "2026-12-18", onHand: 72, reserved: 20, status: "Karantina" },
  { id: "stk-004", productId: "raw-ragi", warehouse: "Gudang Bahan Baku", lot: "RGI-260710-A", expiryDate: "2026-09-03", onHand: 14000, reserved: 4000, status: "Tersedia" },
  { id: "stk-005", productId: "pack-plastik", warehouse: "Gudang Kemasan", lot: "PKG-260803", expiryDate: "2028-08-03", onHand: 4850, reserved: 1200, status: "Tersedia" },
  { id: "stk-006", productId: "prd-roti-susu", warehouse: "Gudang Produk Jadi", lot: "RS-260823-P1", expiryDate: "2026-08-26", onHand: 340, reserved: 40, status: "Tersedia" },
  { id: "stk-007", productId: "prd-roti-cokelat", warehouse: "Gudang Produk Jadi", lot: "RC-260822-P4", expiryDate: "2026-08-25", onHand: 268, reserved: 30, status: "Tersedia" },
  { id: "stk-008", productId: "prd-roti-susu", warehouse: "Gudang Produk Jadi", lot: "RS-260822-P3", expiryDate: "2026-08-25", onHand: 142, reserved: 20, status: "Tersedia" },
  { id: "stk-009", productId: "prd-tawar", warehouse: "Gudang Produk Jadi", lot: "RT-260822-P2", expiryDate: "2026-08-27", onHand: 131, reserved: 12, status: "Tersedia" },
  { id: "stk-010", productId: "prd-pisang", warehouse: "Area Ditahan", lot: "BP-260821-P1", expiryDate: "2026-08-25", onHand: 24, reserved: 0, status: "Ditahan" },
...
export const sales: Sale[] = [
  ...
  { id: "sale-005", number: "SO-PST-260823-0022", salesAdminId: "usr-rina", customerId: "cust-mitra", customerCategory: "Agen 1", createdAt: "2026-08-23T09:05:00+07:00", neededAt: "2026-08-24T08:00:00+07:00", items: [{ productId: "prd-roti-keju", quantity: 120, unitPrice: 9500 }, { productId: "prd-pisang", quantity: 90, unitPrice: 7000 }], subtotal: 1770000, discount: 0, total: 1770000, paidAmount: 350000, paymentMethod: "Transfer", orderSource: "Telepon", fulfillmentMethod: "Diambil", status: "Menunggu Produksi", paymentTermsDaysSnapshot: 14, creditLimitSnapshot: 12000000, dueDate: "2026-09-07" },
];
...
export const productionOrders: ProductionOrder[] = [
  { id: "prod-001", batchNumber: "PRD-RS-260823-P1", productId: "prd-roti-susu", recipeVersion: "v3.2", targetQty: 600, actualQty: 584, wasteQty: 16, scheduledAt: "2026-08-23T02:00:00+07:00", startedAt: "2026-08-23T02:04:00+07:00", completedAt: "2026-08-23T05:48:00+07:00", machine: "Oven Rotary 01", team: "Tim Pagi A", status: "Selesai", priority: "Tinggi" },
  { id: "prod-002", batchNumber: "PRD-RC-260823-P2", productId: "prd-roti-cokelat", recipeVersion: "v2.8", targetQty: 520, actualQty: 0, wasteQty: 0, scheduledAt: "2026-08-23T06:00:00+07:00", startedAt: "2026-08-23T06:12:00+07:00", machine: "Oven Rotary 02", team: "Tim Pagi B", status: "Berjalan", priority: "Mendesak" },
  { id: "prod-003", batchNumber: "PRD-RK-260823-P3", productId: "prd-roti-keju", recipeVersion: "v2.4", targetQty: 420, actualQty: 408, wasteQty: 12, scheduledAt: "2026-08-23T04:30:00+07:00", startedAt: "2026-08-23T04:42:00+07:00", completedAt: "2026-08-23T08:16:00+07:00", machine: "Oven Deck 03", team: "Tim Pagi A", status: "Menunggu QC", priority: "Normal" },
  { id: "prod-004", batchNumber: "PRD-RT-260823-P4", productId: "prd-tawar", recipeVersion: "v4.1", targetQty: 260, actualQty: 0, wasteQty: 0, scheduledAt: "2026-08-23T10:00:00+07:00", machine: "Oven Deck 01", team: "Tim Siang", status: "Dijadwalkan", priority: "Normal" },
];

export const qualityInspections: QualityInspection[] = [
  { id: "qc-001", number: "QC-FG-260823-031", type: "Produk Jadi", reference: "PRD-RK-260823-P3", itemName: "Roti Keju", lot: "RK-260823-P3", inspector: "Fikri Ramadhan", createdAt: "2026-08-23T08:21:00+07:00", status: "Menunggu", checks: [{ name: "Berat rata-rata", value: "58 g", result: "Lulus" }, { name: "Warna permukaan", value: "Cokelat merata", result: "Lulus" }, { name: "Kerapatan segel", value: "Belum diperiksa", result: "Gagal" }] },
  { id: "qc-002", number: "QC-RM-260823-030", type: "Bahan Masuk", reference: "GR-PST-260823-011", itemName: "Mentega Bakery", lot: "MTG-260820-C", inspector: "Fikri Ramadhan", createdAt: "2026-08-23T07:35:00+07:00", status: "Ditahan", checks: [{ name: "Suhu saat diterima", value: "12.8 C", result: "Gagal" }, { name: "Kemasan", value: "Utuh", result: "Lulus" }] },
  { id: "qc-003", number: "QC-PRO-260823-029", type: "Proses", reference: "PRD-RC-260823-P2", itemName: "Roti Cokelat", lot: "RC-260823-P2", inspector: "Fikri Ramadhan", createdAt: "2026-08-23T07:10:00+07:00", status: "Lulus", checks: [{ name: "Suhu adonan", value: "27.4 C", result: "Lulus" }, { name: "Waktu proofing", value: "48 menit", result: "Lulus" }] },
];
...
export const purchaseOrders: PurchaseOrder[] = [
  ...
  { id: "po-003", number: "PO-PST-260823-018", supplierId: "sup-kemasan", supplierNameSnapshot: "CV Kemasan Prima", createdAt: "2026-08-23", expectedAt: "2026-08-26", paymentTermsDaysSnapshot: 21, items: [{ productId: "pack-plastik", quantity: 100, purchaseUnit: "Pack", purchaseContentValue: 100, purchaseContentUnit: "Pcs", stockUnit: "Pcs", conversionValue: 100, unitPrice: 35000, receivedQty: 0 }], total: 3500000, status: "Menunggu Persetujuan" },
];
...
export const expenses: Expense[] = [
  ...
  { id: "exp-002", number: "EXP-PST-260823-022", department: "Penjualan", category: "Perlengkapan POS", payee: "Toko Perkakas Bandung", amount: 780000, date: "2026-08-23", status: "Menunggu Persetujuan" },
];
...
export const employees: Employee[] = [
  ...
  { id: "emp-006", number: "RH-011", name: "Fikri Ramadhan", department: "Quality Control", jobTitle: "QC Inspector", employmentType: "Tetap", basePay: 5600000, attendanceStatus: "Hadir", overtimeHours: 1 },
...
export const approvals: Approval[] = [
  { id: "apr-001", type: "Pembelian", reference: "PO-PST-260823-018", title: "Pembelian 10.000 plastik roti", requester: "Ratna Wulandari", context: "Purchasing", amount: 4050000, requestedAt: "2026-08-23T08:32:00+07:00", reason: "Stok cukup untuk 4 hari produksi", status: "Menunggu" },
  { id: "apr-002", type: "Biaya", reference: "EXP-PST-260823-022", title: "Pengadaan perlengkapan POS", requester: "Siti Nurhayati", context: "Penjualan", amount: 780000, requestedAt: "2026-08-23T08:12:00+07:00", reason: "Perlengkapan lama rusak dan tidak aman", status: "Menunggu" },
  { id: "apr-003", type: "Koreksi Stok", reference: "ADJ-PST-260823-004", title: "Selisih ragi instan 1,4 kg", requester: "Yudi Hermawan", context: "Gudang Bahan Baku", amount: 100800, requestedAt: "2026-08-23T07:54:00+07:00", reason: "Kemasan terbuka saat stok opname", status: "Menunggu" },
];
...
export const notifications: AppNotification[] = [
  ...
  { id: "ntf-002", title: "Batch Roti Keju menunggu QC", message: "PRD-RK-260823-P3 selesai sejak 08:16.", type: "warning", module: "Produksi & QC", createdAt: "2026-08-23T08:21:00+07:00", read: false },
