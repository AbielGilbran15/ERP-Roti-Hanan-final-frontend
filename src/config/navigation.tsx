...
export const mainNavigation: NavigationItem[] = [
  ...
  { label: "Produksi & QC", href: "/production", icon: BuildingFactory24Regular, roles: routeAccess["/production"] },
...
export const controlNavigation: NavigationItem[] = [
  { label: "Persetujuan", href: "/approvals", icon: ClipboardTaskListLtr24Regular, roles: routeAccess["/approvals"] },
...
export const mobileQuickLinks: NavigationItem[] = [
  ...
  mainNavigation[1],
  mainNavigation[2],
  { label: "Peringatan", href: "/approvals", icon: Alert24Regular, roles: routeAccess["/approvals"] },
];
